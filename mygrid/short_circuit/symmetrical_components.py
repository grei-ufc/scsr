    ...
    if sc_type == 'three-phase':
        ...
        for current_feeder, r in substation.feeders.items():
            for section in substation.feeders[current_feeder].sections.values():
                ...
                three_phase_sc.append([section.n2.name,
                                        str(sc.pu),
                                        str(sc.m)])
        ...
        for current_feeder, r in substation.feeders.items():
            for section in substation.feeders[current_feeder].sections.values():
                ...
                line_to_ground_sc.append([section.n2.name,
                                         str(sc.pu),
                                         str(sc.m)])
        ...
        for current_feeder, r in substation.feeders.items():
            for section in substation.feeders[current_feeder].sections.values():
                ...
                line_to_line_sc.append([section.n2.name,
                                       str(sc.pu),
                                       str(sc.m)])
        ...
        for current_feeder, r in substation.feeders.items():
            for section in substation.feeders[current_feeder].sections.values():
                ...
                line_to_ground_min_sc.append([section.n2.name,
                                                str(sc.pu),
                                                str(sc.m)])
